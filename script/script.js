...
biblioteca.registrarUsuario(cliente)
biblioteca.registrarUsuario(cliente2)

biblioteca.emprestarLivro(livro, cliente)
console.log(biblioteca.emprestarLivro(livro, cliente2))

console.log(biblioteca.fecharEmprestimo(livro, cliente))

console.log(biblioteca.emprestimos)